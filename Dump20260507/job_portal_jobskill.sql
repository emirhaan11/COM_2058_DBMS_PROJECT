...
CREATE TABLE `jobskill` (
  `JobSkillID` int NOT NULL AUTO_INCREMENT,
  `JobID` int NOT NULL,
  ...
  CONSTRAINT `jobskill_ibfk_1` FOREIGN KEY (`JobID`) REFERENCES `jobposting` (`JobID`) ON DELETE CASCADE,
  CONSTRAINT `jobskill_ibfk_2` FOREIGN KEY (`SkillID`) REFERENCES `skill` (`SkillID`) ON DELETE CASCADE
